...
export default function OnBoardingOne() {
  ...
  return (
    <View style={styles.container}>
      <Image 
        source={require('../../assets/images/userOnboard/Welcome-cuate 1.png')} 
        style={styles.image}
      />
      <Text style={styles.title}>Welcome To TiJi</Text>
      <Text style={styles.subtitle}>Your one-stop travel solution</Text>
      <TouchableOpacity 
        style={styles.button} 
